...
import { deleteProductsThunk, getProductsThunk } from '../../store/products/thunk';
import { productsSelector } from '../../store/products/selectors';
import { useDeleteProductsMutation, useGetProductsQuery } from '../../store/products/productsAPI';
